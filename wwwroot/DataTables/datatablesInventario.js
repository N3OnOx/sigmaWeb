    ...
    (function($, window, document, undefined) {
        ...
        DataTable.defaults = {
            ...
            "oLanguage": {
                 ...
                 * 
                 */
                "sLengthMenu": '<a class="text-left ml-lg-4 text-success" data-toggle="modal" data-target="#modalNuevoCM">' +
                    '<i class="fas fa-2x fa-plus-circle mr-3" style="font-size:2.5em"></i>' +
                    '</a>' + "Ver _MENU_ entradas",
